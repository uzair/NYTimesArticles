...
final class ArticleRepositoryTests: XCTestCase {
    ...
    func testGetConsentList_successfulCall() {
        
        // Expectation
        let expectation = XCTestExpectation(description: "testGetConsentList_successfulCall")
    ...
    func testGetConsentList_failureCall() {
        
        // Expectation
        let expectation = XCTestExpectation(description: "testGetConsentList_failureCall")
